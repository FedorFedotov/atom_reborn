...
public class ChatController {
    ...
    private static final String HISTORY_FILE_NAME = "ChatLogs.txt";
    ...
    public ResponseEntity<String> login(@RequestParam("name") String name) {
        ...
        String message = "[" + dateFormat.format(now) + "] [Пользователь:" + name + "] logged in";
    ...
    public ResponseEntity logout(@RequestParam("name") String name) {
        ...
        String message = "[" + dateFormat.format(now) + "] [Пользователь:" + name + "] logged out";
        messages.add(message);
        writeToFile(message);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity say(@RequestParam("name") String name, @RequestParam("msg") String msg) {
        ...
        String message = "[" + dateFormat.format(now) + "] [Пользователь:" + name + "] " + msg;
        messages.add(message);
        writeToFile(message);
        return ResponseEntity.ok().build();
    }
